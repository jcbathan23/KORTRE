...
(2, '201', 'A1', 2, '2024-03-02', '2024-03-15', 'occupied', NULL, 0, '2025-05-20 12:14:37'),
(3, '301', 'A1', 3, '2024-03-03', '2024-03-08', 'occupied', NULL, 0, '2025-05-20 12:14:37');
...
(3, 1, 35.1, '120/80', 43, 'improving', '2025-05-19 17:40:00', '2123', 1, '2025-05-19 15:41:55');
...
INSERT INTO `payments` (`payment_id`, `patient_id`, `first_name`, `middle_initial`, `last_name`, `diagnosis`, `payment_status`, `bill_id`, `amount`, `payment_date`, `payment_method`, `reference_number`, `received_by`, `created_at`) VALUES
(3, '1', 'john', 'm', 'cena', 'Cancer', 'paid', NULL, 0.00, '0000-00-00 00:00:00', 'Cash', NULL, NULL, '2025-05-19 14:55:19');
...
(2, 'MediSupply Co.', 'Jane', 'jane@medisupply.com', '+0987654321', '456 Medi Ave.', 'active', '2025-05-14 13:52:02');
...
--
ALTER TABLE `pharmacy_inventory`
  ADD CONSTRAINT `pharmacy_inventory_ibfk_1` FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`medicine_id`),
  ADD CONSTRAINT `pharmacy_inventory_ibfk_2` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`supplier_id`);
